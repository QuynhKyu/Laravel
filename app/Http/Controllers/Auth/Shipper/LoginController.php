...
class LoginController extends Controller
{
    ...
    /**
     * phương thức trả về view để đăng nhập cho shipper
     */
    ...
    public function loginShipper(Request $request)
    {
        ...
        {
            // đăng nhập thành công thì sẽ chuyển hướng về view dashboard của shipper
    ...
    public function logout()
    {
        ...
        // sau khi đăng xuất sẽ chuyển hướng về trang login của shipper
