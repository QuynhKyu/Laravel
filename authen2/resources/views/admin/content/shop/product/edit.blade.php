...
@section('content')
    ...
    <div class="row">
        ...
        <div class="form-three widget-shadow">
            <form name="category" action="{{ url('admin/shop/product/'.$product->id) }}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="cat_id">
                            ...
                            @foreach($cats as $cat)
                                <option value="{{ $cat->id }}" <?php echo ($product->id == $cat->id) ? 'selected' : '' ?>>{{ $cat->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
