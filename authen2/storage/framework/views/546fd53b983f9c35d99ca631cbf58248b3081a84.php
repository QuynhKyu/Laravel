<?php /* D:\XAMPP\xampp\htdocs\lar.tuto\lar.tuto\authen2\resources\views/frontend/partials/header.blade.php */ ?>
<div class="header-top-w3layouts">
    <div class="container">
        <div class="col-md-6 logo-w3">
            <a href="index.html"><img src="<?php echo e(asset('frontend_assets/images')); ?>/logo2.png" alt=" " /><h1>FASHION<span>CLUB</span></h1></a>
        </div>
                            ...
                            <ul class="dropdown-menu multi">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 w3l">
                                        <a href="women.html"><img src="<?php echo e(asset('frontend_assets/images')); ?>/menu1.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi multi1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 w3l">
                                        <a href="jewellery.html"><img src="<?php echo e(asset('frontend_assets/images')); ?>/menu2.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
